...
public class ModelPag02c {
    ...
    public ModelPag02c(ListView<String> listaPalavras, Label palavraAtual) {
        this.unidadeAtual = 0;
    ...
    public void tocarAudio1() {
        switch (getUnidadeAtual()) {
            ...
            case 4:
                ...
                break;
            default:
                caminhoAudio = "audios/u" + unidadeAtual + "c/l" + unidadeAtual + "p2a1.mp3";
                break;
        }
    ...
    public void tocarAudio2() {
        switch (getUnidadeAtual()) {
            ...
            case 4:
                ...
                break;
            default:
                caminhoAudio = "audios/u" + unidadeAtual + "c/l" + unidadeAtual + "p2a2.mp3";
                break;
        }
    ...
    public void tocarAudio3() {
        switch (getUnidadeAtual()) {
            ...
            case 4:
                ...
                break;
            default:
                caminhoAudio = "audios/u" + unidadeAtual + "c/l" + unidadeAtual + "p2a3.mp3";
                break;
        }
