...
public class ModelPag03d {
    ...
    public void verificarImagem(MouseEvent event) {
        ...
        switch (getUnidadeAtual()) {
            ...
            case 25:
                if (imgClicada.equals("img2") || imgClicada.equals("img4") || imgClicada.equals("img3")) {
                    imgf1 = getClass().getResource("imagens/licao" + unidadeAtual + "d/" + nomeImagem + "c.png");
                } else {
    ...
    public void tocarAudioInicial() {
        switch (getUnidadeAtual()) {
            ...
            case 4:
                ...
                break;
            default:
                caminhoAudio = "audios/u" + getUnidadeAtual() + "d/l" + unidadeAtual + "p3.mp3";
                break;
        }
    ...
    public void definirImagens(int unidadeAtual) {
        ...
        switch (unidadeAtual) {
            ...
            case 3:
                ...
                break;
            default:
                imgf1 = getClass().getResource("imagens/licao" + unidadeAtual + "d/1.png");
                imgf2 = getClass().getResource("imagens/licao" + unidadeAtual + "d/2.png");
                imgf3 = getClass().getResource("imagens/licao" + unidadeAtual + "d/3.png");
                imgf4 = getClass().getResource("imagens/licao" + unidadeAtual + "d/4.png");
                imgf5 = getClass().getResource("imagens/licao" + unidadeAtual + "d/5.png");
                imgf6 = getClass().getResource("imagens/licao" + unidadeAtual + "d/6.png");
                break;
        }
        /**
