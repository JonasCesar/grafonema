...
public class ModelPag04b {
     ...
     * @param listaPalavras
     */
    public ModelPag04b(Label p1, Label p2, Label p3, Label p4, Label p5, Label f1,
    ...
    public boolean verificarEscolhaSilaba(MouseEvent event) throws MalformedURLException {
        ...
        switch (getUnidadeAtual()) {
            ...
            case 8:
                ...
                break;
            case 9:
                if (silabaEscolhida.equals("CE")) {
                    opcaoCorreta = true;
                    imagemUrl = getClass().getResource("imagens/licao9b/cegonhacor.png");
                    imagemAudio.setImage(new Image(imagemUrl.toString()));
                }
                break;
            default:
    ...
    public void tocarAudio() {
        ...
        switch (getUnidadeAtual()) {
            ...
            case 3:
                ...
                break;
            default:
                caminhoAudio = "audios/u" + unidadeAtual + "b/l" + unidadeAtual + "p4.mp3";
                break;
        }
        //executa o audio
