 ...
 * @author shadows
 */
public class Pag03bController implements Initializable {
    ...
    private ModelPag03b modelPag03b;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag03b = new ModelPag03b(img1,img2,img3,img4,img5,img6,instrucao,listaPalavras);
    ...
    public void audioInicial() throws MalformedURLException{
        modelPag03b.tocarAudioInicial();
        setInstrucao(modelPag03b.getUnidadeAtual());
    }
    /**
    ...
    public void setUnidadeAtual(int unidade) throws IOException {
        atualizarListView();
        modelPag03b.setUnidadeAtual(unidade);
    }
    /**
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag03b.pararAudio();
        modelPag03b.proximaPagina(event);    
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag03b.pararAudio();
        modelPag03b.paginaAnterior(event);
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag03b.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    /**
    ...
    private void executarAudioImagem(MouseEvent event) {
        modelPag03b.executarAudioImagem(event);
    ...
    private void abrirManual(ActionEvent event) throws IOException {
        modelPag03b.abrirManual(event, pagina);
    }
    /**
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag03b.abrirABC(event, pagina);
        modelPag03b.pararAudio();
    }

    private void atualizarListView() {
        modelPag03b.atualizarListView();
    }
