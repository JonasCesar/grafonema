 ...
 * @author shadows
 */
public class Pag05bController implements Initializable {
    ...
    private ModelPag05b modelPag05b;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag05b = new ModelPag05b(p1, p2, p3, p4, p5, f1, f2,espaco,
    ...
    public void setUnidadeAtual(int unidadeAtual) throws IOException {
        atualizarListView();
        modelPag05b.setUnidadeAtual(unidadeAtual);
    }
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag05b.pararAudio();
        modelPag05b.proximaPagina(event);
    }
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag05b.pararAudio();
        modelPag05b.paginaAnterior(event);
    }
    /**
    ...
    private void mouseLiberado(MouseEvent event) throws MalformedURLException {
        modelPag05b.mouseLiberado(event);
    ...
    private void mouseArrastado(MouseEvent event) {
        modelPag05b.mouseArrastado(event);        
    }
    /**
    ...
    private void mousePressionado(MouseEvent event) {
        modelPag05b.mousePressionado(event);        
    }
    /**
     * toca o audio da pag 05
     */
    public void tocarAudio() throws MalformedURLException {
        modelPag05b.tocarAudio();
        setInstrucao(modelPag05b.getUnidadeAtual());
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag05b.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag05b.abrirABC(event, pagina);
        modelPag05b.pararAudio();
    }
    /**
