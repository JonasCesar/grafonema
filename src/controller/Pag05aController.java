 ...
 * @author shadows
 */
public class Pag05aController implements Initializable {
    ...
    private ModelPag05a modelPag05a;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag05a = new ModelPag05a(p1, p2, p3, p4, p5, f1, f2,espaco,imagemAudio, janelaPrograma, instrucao, listaPalavras);
    ...
    public void setUnidadeAtual(int unidadeAtual) throws IOException {
        atualizarListView();
        modelPag05a.setUnidadeAtual(unidadeAtual);
    }
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag05a.pararAudio();
        modelPag05a.proximaPagina(event);
    }
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag05a.pararAudio();
        modelPag05a.paginaAnterior(event);
    }
    /**
    ...
    private void mouseLiberado(MouseEvent event) throws MalformedURLException {
        modelPag05a.mouseLiberado(event);
    ...
    private void mouseArrastado(MouseEvent event) {
        modelPag05a.mouseArrastado(event);        
    }
    /**
    ...
    private void mousePressionado(MouseEvent event) {
        modelPag05a.mousePressionado(event);        
    }
    /**
     * toca o audio da pag 05
     */
    public void tocarAudio() throws MalformedURLException {
        modelPag05a.tocarAudio();
        setInstrucao(modelPag05a.getUnidadeAtual());
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag05a.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    ...
    private void abrirManual(ActionEvent event) throws IOException {
        modelPag05a.abrirManual(event, pagina);
    }
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag05a.abrirABC(event, pagina);
        modelPag05a.pararAudio();
    }
    /**
    ...
    public void setInstrucao(int unidadeAtual)    {
        modelPag05a.definirInstrucao(unidadeAtual);
    }
