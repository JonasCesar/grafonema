 ...
 * @author shadows
 */
public class Pag03cController implements Initializable {
    ...
    private ModelPag03c modelPag03c;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag03c = new ModelPag03c(img1,img2,img3,img4,img5,img6,instrucao,listaPalavras);
    ...
    public void audioInicial() throws MalformedURLException{
        modelPag03c.tocarAudioInicial();
        setInstrucao(modelPag03c.getUnidadeAtual());
    }
    /**
    ...
    public void setUnidadeAtual(int unidade) throws IOException {
        atualizarListView();
        modelPag03c.setUnidadeAtual(unidade);
    }
    /**
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag03c.pararAudio();
        modelPag03c.proximaPagina(event);    
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag03c.pararAudio();
        modelPag03c.paginaAnterior(event);
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag03c.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    /**
    ...
    private void executarAudioImagem(MouseEvent event) {
        modelPag03c.executarAudioImagem(event);
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag03c.abrirABC(event, pagina);
        modelPag03c.pararAudio();
    }

    private void atualizarListView() {
        modelPag03c.atualizarListView();
    }
