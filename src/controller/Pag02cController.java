 ...
 * @author shadows
 */
public class Pag02cController implements Initializable {

    @FXML
    private Label palavraAtual;

    private ModelPag02c modelPag02c;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag02c = new ModelPag02c(listaPalavras, palavraAtual);
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag02c.pararAudio();
        modelPag02c.proximaPagina(event);
    }
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag02c.pararAudio();
        modelPag02c.paginaAnterior(event);
    }
    ...
    public int getUnidadeAtual() {
        return modelPag02c.getUnidadeAtual();
    }
    ...
    public void setUnidadeAtual(int unidade) throws IOException {
        atualizarListView();        
        modelPag02c.setUnidadeAtual(unidade);
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag02c.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    ...
    private void abrirManual(ActionEvent event) throws IOException {
        modelPag02c.abrirManual(event, pagina, "c");
    }
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag02c.abrirABC(event, pagina);
        modelPag02c.pararAudio();
    }

   @FXML
    private void sugestaoAtividades(ActionEvent event) throws IOException {
        modelPag02c.sugestaoAtividade(event, pagina);
    }

    private void atualizarListView() {
        modelPag02c.atualizarListView();
    }
}
