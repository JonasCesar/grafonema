 ...
 * @author iran
 */
public class Gui_FimJogoController implements Initializable {


    private Model_fimJogo fimJogo = new Model_fimJogo();
    ...
    private void reiniciarJogo(MouseEvent event) throws IOException {
        fimJogo.reiniciarJogo(imgReiniciar);
    }

    @FXML
    private void sairJogo(MouseEvent event) {
        fimJogo.sairJogo(imgSair);
    }
    /**
