 ...
 * @author shadows
 */
public class Pag02bController implements Initializable {

    @FXML
    private Label palavraAtual;

    private ModelPag02b modelPag02b;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modelPag02b = new ModelPag02b(listaPalavras, palavraAtual);
    ...
    private void avancar(ActionEvent event) throws IOException {
        modelPag02b.pararAudio();
        modelPag02b.proximaPagina(event);
    }
    ...
    private void voltar(ActionEvent event) throws IOException {
        modelPag02b.pararAudio();
        modelPag02b.paginaAnterior(event);
    }
    ...
    public int getUnidadeAtual() {
        return modelPag02b.getUnidadeAtual();
    }
    ...
    public void setUnidadeAtual(int unidade) throws IOException {
        atualizarListView();        
        modelPag02b.setUnidadeAtual(unidade);
    }
    ...
    private void mouseClicado(MouseEvent event) {
        ...
        modelPag02b.tocarAudioPalavraSelecionada(palavraSelecionada);
    }
    ...
    private void abrirManual(ActionEvent event) throws IOException {
        modelPag02b.abrirManual(event, pagina, "b");
    }
    ...
    private void abrirABC(ActionEvent event) throws IOException {
        modelPag02b.abrirABC(event, pagina);
        modelPag02b.pararAudio();
    }

   @FXML
    private void sugestaoAtividades(ActionEvent event) throws IOException {
        modelPag02b.sugestaoAtividade(event, pagina);
    }

    private void atualizarListView() {
        modelPag02b.atualizarListView();
    }
}
